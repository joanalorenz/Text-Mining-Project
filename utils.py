...
# Function to create, and sample a SQL database for our articles
class SQL:
...
# Text processing (tokenization, stop words, stemming)
...
# similarity between a sentences and query vector given a model
...
# Get the best sentences based on the similarity quantile
...
# Get best combination of sentences, maximizing similarity while staying within the num_of_char limit
...
# Create the summary by concatenating the sentences
...
# Get most similar sentence to query vector
...
def get_article(url):
    ...
    return  content_str, title

# Twitter posting function
# We do this by sending a specific http protocol in order to access our Twitter account and post our summary
# 
...
# ELMO approach for entity recognition
# We did not include this approach, however, because we were lacking calculation power to train the model appropriately 
